...
describe('compile()', () => {
  ...
  describe('compile error test', () => {
    it('should compile fail with import error 1', () => {
    ...
    it('should compile fail with import error 2', () => {
    ...
    it('should compile fail with import error 3', () => {
  ...
  describe('output warnings test', () => {
    ...
    it('warnings and errors should be right 1', () => {
      const result = compileContract(
    ...
    it('warnings and errors should be right 2', () => {
      const result = compileContract(
